...
export default function ProductItem({product}) {
  return (
    ...
    <div className='bg-white flex flex-col items-center text-center gap-y-1 p-3 relative'>
      <button className=' absolute top-2 rounded-md right-2 p-2 font-semibold bg-white shadow-md text-brand-color hover:text-brand-yellow hover:bg-secondary-brand-color' > <FiPlus size={16}/> </button>
